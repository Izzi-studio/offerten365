    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-custom alert-white alert-shadow fade show gutter-b">
                <h1>{{__('admin/admin.menu.reviews')}}</h1>
            </div>
            <div class="card card-custom card-stretch gutter-b">
                <div class="card-header border-0 pt-5">
                    <p>
                        <a class="btn btn-success mr-2" href="{{route('reviews.create')}}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-vertical-center">
                            ...
                            @foreach($reviews as $review)
                                <tr>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$review->id}}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$review->getReviewDescription->name}}</span>
                                    </td>
                                    <td class="text-right">
                                        ...
                                        <a  data-toggle="modal" data-target="#exampleModalLong" data-form="#delete-form{{$review->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                            <span class="svg-icon svg-icon-md svg-icon-primary">
