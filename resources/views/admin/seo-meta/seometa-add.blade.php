    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-custom alert-white alert-shadow fade show gutter-b">
                <h1>{{__('admin/admin.form.add-seo-meta')}}</h1>
            </div>
                    ...
                    <form action="{{route('seo-meta.store')}}" method="POST" enctype="multipart/form-data">
                        <div class="tab-content mt-5" id="myTabContent">
                            ...
                            <div class="form-group">
                                <label>
                                    {{__('admin/admin.form.type')}}:
                                </label>
                                <input required="required" class="form-control" type="text" name="type" value=""/>
                                @error('type')
                            ...
                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                ...
                                <div class="tab-pane fade @if($flag) show active @endif" id="{{ $localeCode }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required="required" class="form-control" type="text" name="seometa[{{ $localeCode }}][title]"
                                               value=""/>
                                    </div>
                                    <div class="form-group">
                                        <label>
                                        ...
                                        <input required="required" class="form-control" type="text"
                                               name="seometa[{{ $localeCode }}][description]" value=""/><br>
                                    </div>
                                </div>
