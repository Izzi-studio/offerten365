...
<style>
    ...
    .custom-file-label::after {
        content: "{{__('admin/admin.form.browse')}}";
    }
    </style>
</head>
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            <div class="brand flex-column-auto" id="kt_brand">
                <!--begin::Logo-->
                <a class="brand-logo" style="color:#fff;font-size: 24px">
                    TRANSFERS
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    @endphp
                    <ul class="menu-nav">
                        <li class="menu-item @if(strpos($actual_link,route('blog.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('blog.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.blog')}}</span>
                            </a>
                        </li>
                        <li class="menu-item @if(strpos($actual_link,route('blog-categories.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('blog-categories.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.blog-categories')}}</span>
                            </a>
                        </li>
                        <li class="menu-item @if(strpos($actual_link,route('faq.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('faq.index')}}" class="menu-link">
                                <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Code\Question-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <li class="menu-item @if(strpos($actual_link,route('reviews.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('reviews.index')}}" class="menu-link">
                                <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Half-star.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <polygon points="0 0 24 0 24 24 0 24"/>
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.reviews')}}</span>
                            </a>
                        </li>
                        <li class="menu-item @if(strpos($actual_link,route('static-page.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('static-page.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.static-pages')}}</span>
                            </a>
                        </li>

                        <li class="menu-item @if(strpos($actual_link,route('custom-page.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('custom-page.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.custom-pages')}}</span>
                            </a>
                        </li>
                        <li class="menu-item @if(strpos($actual_link,route('seo-meta.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('seo-meta.index')}}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.seo-meta')}}</span>
                            </a>
                        </li>
                        <li class="menu-item @if(strpos($actual_link,route('proposals.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                        ...
                        <li class="menu-item @if(strpos($actual_link,route('setting.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('setting.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.settings')}}</span>
                            </a>
                        </li>

                        <li class="menu-item @if(strpos($actual_link,route('partners.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('partners.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.partners')}}</span>
                            </a>
                        </li>
                        <li class="menu-item @if(strpos($actual_link,route('email-templates.index').'/')!==false) menu-item-active @endif" aria-haspopup="true">
                            <a href="{{route('email-templates.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.email-templates')}}</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('logout') }}"
                                ...
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Electric\Shutdown.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"/>
                                ...
                                <span class="menu-text">{{__('admin/admin.menu.logout')}}</span>
                            </a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Möchten Sie diesen Artikel wirklich löschen?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Nein</button>
                <button type="button" class="btn btn-primary font-weight-bold btn-ok">JA</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="email-templates" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
...
<div class="modal fade" id="mailing-emails" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    ...
    <script>
        ...
        var elementExists = document.getElementById("image_input");


        if(elementExists) {
                document.getElementById("image_input").addEventListener("change", readFile);
            }
        ...
        $('#exampleModalLong').on('show.bs.modal', function(e) {
            $(this).find('.btn-ok').click(function () {
                $($(e.relatedTarget).data('form')).submit();
            })
        });

        $.ajax({
            url: '/api/administrator/email-templates?type=invoice',             
            dataType : "json",                     
        ...
        $('#email-templates').on('show.bs.modal', function(e) {
            $('#form-email-template')[0].invoice_id.value = $(e.relatedTarget).attr('data-invoice-id')
        });

        $('#form-email-template').submit(function(e) {
            e.preventDefault()
            $('#btn-form-email-temlates').attr("disabled", true)

            const formData = new FormData(e.target);    

            $.ajax({
                url: $('#form-email-template').attr('action'),
                data: formData,
                processData: false,
                contentType: false,
                type: 'POST',
...
<script>
    $('#accept, #reject').click(function (){
        if($(this).val() == 'accept'){
            $('[name="action"]').val('accept')
        }
        if($(this).val() == 'reject'){
            $('[name="action"]').val('reject')
        }
